...
def parse():
	...
	parser.add_argument("-d", "--duplicate", dest = "duplicate", default = 1, help = "Check if image filename already exists in the directory. If yes, the image will not be downloaded. If no, file will be replaced. Values: 1 = check; 0 = don't check; Default = 1", type = int)
